        ...
        <div className="modal-content">
          ...
          <section className="details-section">
            <div className="section-header">
              ...
              <h3 className="section-title">Grade Averages</h3>
            </div>
          ...
          <section className="details-section">
            <div className="section-header">
              ...
              <h3 className="section-title">Grade Status</h3>
            </div>
          ...
          <section className="details-section">
            <div className="section-header">
              ...
              <h3 className="section-title">Allowance Eligibility</h3>
            </div>
          ...
          {grade.grade_sheet && (
            <section className="details-section">
              <div className="section-header">
                ...
                <h3 className="section-title">Grade Sheet Document</h3>
              </div>
