        ...
        <div className="success-modal-content">
          <div className="success-celebration">
            ...
            <div className="success-header-modal">
              <div className="tcu-logo-success-modal">
                <div className="logo-circle-success-modal">
                  <img src="/images/TCU_logo.png" alt="TCU Logo" className="tcu-logo-img-success-modal" />
                </div>
              </div>
              <h1 className="university-name-success-modal">Taguig City University</h1>
            </div>
            
            <div className="success-content-wrapper-modal">
              <div className="success-icon-wrapper-modal">
                <div className="success-checkmark-modal">
              ...
              <div className="success-message-content-modal">
                <h2 className="success-title-modal">Registration Successful!</h2>
                <p className="success-subtitle-modal">Welcome to TCU-CEAA</p>
                
                <div className="success-details-modal">
                  <div className="success-detail-item-modal">
                    <div className="detail-icon-modal">
                ...
                <div className="success-actions-modal">
                  <button
                    onClick={onGoToLogin}
                    className="success-primary-button-modal"
                  >
  ...
  return (
    <div className="registration-modal-container">
      <div className="registration-modal-content">
        ...
        <form onSubmit={handleSubmit} className="registration-modal-form">
          {error && (
          ...
          <div className="form-row-modal">
            ...
            <div className="form-group-modal">
              ...
              <input
                ...
                maxLength={8}
              />
              <small className="form-hint-modal">Format: YY-XXXXX</small>
            </div>
          </div>
          ...
          <div className="terms-section-modal">
            <p className="terms-text-modal">
          ...
          <div className="form-footer-modal">
            <button
              type="button"
              onClick={onGoToLogin}
